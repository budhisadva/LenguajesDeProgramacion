...
happyExpList = Happy_Data_Array.listArray (0,46) ([9088,512,0,0,0,0,0,448,2272,8192,32768,0,8,32800,35,256,0,0,32768,0,2049,0,32784,35,142,568,0,16384,0,4,4,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","ASAS","LASAS","BIND","LBIND","id","int","bool","op","let","lets","'('","')'","'['","']'","%eof"]
        bit_start = st * 18
        bit_end = (st + 1) * 18
...
action_26 (15) = happyShift action_27
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenOp happy_dollar_dollar -> cont 11;
	TokenLet -> cont 12;
	TokenLetStar -> cont 13;
	TokenPA -> cont 14;
	TokenPC -> cont 15;
	TokenCA -> cont 16;
	TokenCC -> cont 17;
